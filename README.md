...
- [XtraFinder](https://www.trankynam.com/xtrafinder/): Adds lots of enhancements to Finder, such as a context menu with "New Text File", "New Terminal Here", "Copy Path", and others. It brings a lot of features that I "miss" from Windows (OMG what did he say?)[2]. **(Free)**
